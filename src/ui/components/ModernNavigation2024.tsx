...
export function ModernNavigation2024({
  onQuickActionsToggle,
}: ModernNavigation2024Props = {}) {
  ...
  const navigationItems: NavigationItem[] = [
    ...
    },
    {
      ...
      label: "Lato z Radiem 2026",
      description: "Zapraszamy na trasę Lata z Radiem 2026!",
      href: "#lato-z-radiem-2026",
      icon: "",
      category: "content",
      keywords: [
        "radio",
    ...
    },
    {
      ...
      label: "Lato z Radiem 2025",
      description: "Wspominamy trasę koncertową z Polskim Radiem",
      href: "#lato-z-radiem-2025",
      icon: "",
      category: "content",
      keywords: [
        "radio",
    ...
    {
      id: "melchiory-2026",
      label: "Melchiory 2026",
      description: "Gala Nagród Dziennikarskich Polskiego Radia",
      href: "#melchiory-2026",
      icon: "",
      category: "content",
      keywords: [
