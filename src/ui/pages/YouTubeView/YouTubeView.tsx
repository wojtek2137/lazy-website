...
const videoData = [
  ...
  },
  {
    ...
    description:
      "Autorski utwór Crack The Beat z teledyskiem w krakowskiej scenerii",
  },
];
  ...
  return (
    <section id="wideo" aria-labelledby="video-heading">
      <ModernYouTubeSection>
        <header>
          <YouTubeHeader id="video-heading">YouTube</YouTubeHeader>
        </header>

        <ModernVideoGrid
          role="list"
          aria-label="Lista filmów zespołu na YouTube"
        >
          {videoData.map((video) => (
